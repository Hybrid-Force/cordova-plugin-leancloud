module.exports = function(root, gulp, gulp_done) {
  ...
  function patchSource(opt, gulp, gulp_done) {
    ...
    gulp.src(path.join(root,
        "platforms/android/src/me/xyzhang/cordova/leanpush/LeanApplication.java"
      ))
      ...
      .pipe(gulp.dest(path.join(root,
        "platforms/android/src/me/xyzhang/cordova/leanpush")));
    ...
    // main_activity_dir_path = path.join(main_activity_path, 'MainActivity.java');
    // console.log(main_activity_path);

    var lpush_main_activity_path = path.join(root,
      'plugins/cordova-plugin-leanpush/other/MainActivity.java');
